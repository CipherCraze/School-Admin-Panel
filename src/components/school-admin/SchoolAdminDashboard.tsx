      ...
      <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0 flex-1">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold gradient-text">
            {mockSchoolData.schoolInfo.name}
          </h1>
        ...
        <div className="flex-shrink-0">
          <div className="text-xs sm:text-sm text-secondary-500 bg-white/80 px-3 sm:px-4 py-2 rounded-xl backdrop-blur-sm border border-secondary-200">
            {mockSchoolData.schoolInfo.board} Board • Last updated: {new Date().toLocaleString()}
          </div>
        </div>
      </div>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-secondary-900 mt-2">{mockSchoolData.schoolInfo.totalStudents}</p>
              ...
              <div className="relative flex-shrink-0">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl opacity-20"></div>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-secondary-900 mt-2">{mockSchoolData.schoolInfo.totalClasses}</p>
                <div className="mt-2 flex items-center">
              ...
              <div className="relative flex-shrink-0">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-xl opacity-20"></div>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-secondary-900 mt-2">86.2%</p>
                <div className="mt-2 flex items-center">
              ...
              <div className="relative flex-shrink-0">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl opacity-20"></div>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-secondary-900 mt-2">830 pts</p>
                <div className="mt-2 flex items-center">
              ...
              <div className="relative flex-shrink-0">
                <div className="absolute inset-0 bg-gradient-to-r from-amber-50 to-amber-100 rounded-xl opacity-20"></div>
        ...
        <Card className="animate-slide-up" style={{ animationDelay: '400ms' }}>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={250} className="sm:h-[280px]">
              <BarChart data={mockSchoolData.classwiseEnrollment}>
                <defs>
      ...
      <Card className="animate-slide-up" style={{ animationDelay: '600ms' }}>
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            {mockSchoolData.topStudents.map((student) => (
                ...
                <Card hover className="overflow-hidden transition-all duration-300 group-hover:scale-105 border-2 border-transparent group-hover:border-gradient-to-r group-hover:from-amber-400 group-hover:to-orange-500">
                  <CardContent className="p-4 relative">
                    <div className="text-center">
                      ...
                      {/* Student Info */}
                      <h3 className="font-bold text-sm text-secondary-900 truncate mb-1">{student.name}</h3>
      ...
      <Card className="animate-slide-up" style={{ animationDelay: '700ms' }}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              >
                ...
                {mockSchoolData.classwiseEnrollment.map((cls) => (
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {[...mockSchoolData.topStudents, ...mockSchoolData.allStudents]
              .filter(student => 
              ...
              <Card key={student.id} hover className="overflow-hidden">
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    />
                    <div className="min-w-0 flex-1">
                      <h3 className="font-semibold text-sm text-secondary-900 truncate">{student.name}</h3>
          ...
          <div className="text-center mt-6">
            <Button variant="outline">
              Load More Students ({mockSchoolData.schoolInfo.totalStudents - 12} remaining)
            </Button>
          </div>
        </CardContent>
      </Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-secondary-900">{selectedStudent.accuracy}%</p>
                    </div>
                    <div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-lg font-semibold text-secondary-900">{selectedStudent.class}</p>
                    </div>
